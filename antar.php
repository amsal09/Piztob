...
$id_user = $row['id'];
	...
	<section>
		<div class="container">
			...
			<form method="POST" action="checkout_proses.php?harga_akhir=<?php echo $tot ?>">
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li name="total">Total Harga <span><?php echo $s; ?></span></li>
							<li name="antar">Shipping Cost <span><?php echo $ship; ?></span></li>
							<li name="harga_akhir">Total <span><?php echo $tot ?></span></li>
						</ul>
